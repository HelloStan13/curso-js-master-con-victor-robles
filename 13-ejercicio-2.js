...
introducidos hasta introducir 
un numero negativo y ahi mostrar el resutlado */

var suma = 0;
var contador = 0;

do{
    var numero= parseInt(prompt('Introduce numeros hasta que metas unos negativo',0));
if(isNaN(numero)){
    numero=0;
